...
## Câu 18 - **Các thành phần chính của hệ thống máy tính gồm:**
...
Tấn công sử dụng các kỹ thuật xã hội (Social engineering attack) là dạng tấn công phi kỹ thuật nhằm vào người dùng. D.Máy trạm
...
B.Thực hiện tấn công tràn bộ đệm. C.Đánh cắp dữ liệu từ máy chủ cơ sở dữ liệu
...
C. Được sử dụng rộng rãi hơn. D. Có chỉ phí rẻ hơn
...
## Câu 7 - **Một tụ điểm của tường lửa có trạng thái so với tường lửa không trạng thái là:**
A. Chạy nhanh hơn
B. Phân biệt được các gói tin thuộc về các kết nối mạng khác nhau. C. Nhận dạng được các dạng tấn công và các phần mềm độc hại
...
C. Tên truy nhập và mật khẩu. D. Thẻ ATM và tên truy nhập
...
## Câu 24 - **Hai dịch vụ quan trọng nhất của một hệ thống điều khiển truy nhập là:**
...
## Câu 11 - **Tìm phát biểu đúng về phát hiện xâm nhập dựa trên chữ ký và phát hiện xâm nhập dựa trên bất thường:**
...
A. Được phép truy cập đến một địa chỉ MAC nhất định. B. Mã hóa địa chỉ MAC của thiết bị không dây. C. Ngăn chặn truy cập từ một địa chỉ MAC nhất định. D. Tường lửa cá nhân
...
A. Tưởng lừa
B. Giao thức DNS
C. Danh sách điều khiển truy cập (ACL). D. Cập nhật vi chương trình ( Firmware)
...
C. Firewall là một phần mềm hoặc phần cứng có khả năng ngăn chặn tấn công từ bên trong và bên ngoài vào hệ thống. D. Firewall là một điểm chặn của trong quá trình điều khiển và giám sát. 
**Đáp án đúng: A**
...
## Câu 4 - **Vai trò của nhân viên đảm bảo an toàn cho thông tin là rất quan trọng trong việc giảm thiểu rủi ro, đảm bảo an toàn cho ... và giảm thiệt hại nếu xảy ra sự cố**
A. Thông tin
...
B. Xác định và triển khai các biện pháp quản lý, kỹ thuật kiểm soát, giảm rủi ro về mức chấp nhận được. C. Đánh giá tình trạng hiện thời các tài sản cần bảo vệ
...
## Câu 27 - **Security and Freedom through Encryption Act, 1999 liên quan tới**
A. Luật về tội phạm máy tính
B. Luật về sư riêng tư
C. Luật bản quyền
D. Luật xuất khẩu và chống gián điệp

**Đáp án đúng: D**

## Câu 28 - **Điều nào sau đây không đúng về ISO 27001**
A. Cung cấp các thông tin để cài đặt một hệ thống quản lý an toàn thông tin
B. Thực thi các yêu cầu của ISO/IEC 27002
C. Cung cấp các chi tiết cho thực hiện chu kỳ PDCA
D. Chỉ rõ cách thức thực hiện để thực hiện quản lý ATTT

**Đáp án đúng: D**

## Câu 29 - **Bộ chuẩn ISO ..... là bộ chuẩn về quản lý ATTT (Information Technology - Code of Practice for Information Security Management) được tham chiếu rộng rãi nhất**
A. 27002
B. 17799
C. 27001
D. 27000
